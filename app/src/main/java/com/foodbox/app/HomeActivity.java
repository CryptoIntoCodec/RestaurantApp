...
import com.foodbox.app.fragments.HomeFragment;
import com.foodbox.app.fragments.ProfileFragment;
import com.foodbox.app.fragments.SearchFragment;
...
public class HomeActivity extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       String dateTime= Utils.getCurrentDate();
       GlobalData.selectedDate=dateTime.split(" ")[0];
        GlobalData.selectedTime=dateTime.split(" ")[1];
        GlobalData.selectedDay=Utils.getCurrentDay();
...
// Change colors
        ...
        try{
            if (bundle!=null){
                if (bundle.getString("type").equals("home")){
                    fragment = new HomeFragment();
                    fragment.setArguments(bundle);
                }else if (bundle.getString("type").equals("search")){
