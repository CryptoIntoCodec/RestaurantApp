...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.foodbox.app.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.foodbox.app.models.Address();
...
//    }
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.foodbox.app.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.foodbox.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.foodbox.app.models.Address> call, @NonNull Response<com.foodbox.app.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.foodbox.app.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.foodbox.app.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.foodbox.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.foodbox.app.models.Address> call, @NonNull Response<com.foodbox.app.models.Address> response) {
                    customDialog.dismiss();
