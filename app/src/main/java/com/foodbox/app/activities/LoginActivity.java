...
import com.foodbox.app.CountryPicker.Country;
import com.foodbox.app.CountryPicker.CountryPicker;
import com.foodbox.app.CountryPicker.CountryPickerListener;
...
import com.foodbox.app.build.configure.BuildConfigure;
...
//    }
    ...
    public void initValues() {
        ...
        if (TextUtils.isValidEmail(edMobileNumber.getText().toString())) {
              value = edMobileNumber.getText().toString();
          //  Toast.makeText(this, "Please enter valid mobile number 11", Toast.LENGTH_SHORT).show();
        }
        if (isValidMobile(country_code + mobile)) {

            value = country_code + mobile;

         }
        if (TextUtils.isEmpty(value)){
            Toast.makeText(this, "Please enter valid mobile number or email", Toast.LENGTH_SHORT).show();
        }
