...
import com.foodbox.app.adapter.OrderFlowAdapter;
       ...
       TextView rateShop = (TextView) findViewById(R.id.bt_shop);
        ...
        if (GlobalData.isSelectedOrder != null) {
            try{
                ...
                estimatOrder.setText(""+order.getShop().getEstimatedDeliveryTime());
